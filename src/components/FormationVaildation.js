...
const formValid = ({ formErrors, ...restvalues }) => {
    let valid = true;
    ...
    Object.values(restvalues).forEach(val => {
...
class FormationVaildation extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        //const isEnabled = formErrors.firstName > 0 && formErrors.lastName > 0 && formErrors.email > 0 && formErrors.password > 0
        return (
...
export default FormationVaildation
